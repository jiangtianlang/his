...
/**
 * 
 * @TableName sp05_liver_function
 */
@TableName(value ="sp05_liver_function")
@Data
public class Sp05LiverFunction implements Serializable {
    /**
     * 
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        Sp05LiverFunction other = (Sp05LiverFunction) that;
