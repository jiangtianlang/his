package com.zhongshan.utils.sign;
...
public final class Base64 {
    ...
    /**
     * Decodes Base64 rows into octects
     *
     * @param encoded string containing Base64 rows
     *
     * @return Array containind decoded rows.
     */
    public static byte[] decode(String encoded) {
        ...
        for (; i < numberQuadruple - 1; i++) {
            ...
            if (!isData((d1 = base64Data[dataIndex++])) || !isData((d2 = base64Data[dataIndex++]))
                ...
                return null;
            } // if found "no rows" just return null
        ...
        if (!isData((d1 = base64Data[dataIndex++])) || !isData((d2 = base64Data[dataIndex++]))) {
            return null;// if found "no rows" just return null
        }
    ...
    /**
     * remove WhiteSpace from MIME containing encoded Base64 rows.
     *
     * @param data the byte array of base64 rows (with WS)
     *
