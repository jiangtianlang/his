...
public class Uh04TemporaryRecipeController extends ApiController {
    /**
     * 服务对象
     */
    @Resource
    ...
    public R selectAll(Page<Uh04TemporaryRecipe> page, Uh04TemporaryRecipe uh04TemporaryRecipe) {
        return success(this.uh04TemporaryRecipeService.page(page, new QueryWrapper<>(uh04TemporaryRecipe)));
    }
    ...
    public R selectOne(@PathVariable Serializable id) {
        return success(this.uh04TemporaryRecipeService.getById(id));
    }
    ...
    public R insert(@RequestBody Uh04TemporaryRecipe uh04TemporaryRecipe) {
        return success(this.uh04TemporaryRecipeService.save(uh04TemporaryRecipe));
    }
    ...
    public R update(@RequestBody Uh04TemporaryRecipe uh04TemporaryRecipe) {
        return success(this.uh04TemporaryRecipeService.updateById(uh04TemporaryRecipe));
    }
    ...
    public R delete(@RequestParam("idList") List<Long> idList) {
        return success(this.uh04TemporaryRecipeService.removeByIds(idList));
    }
}
