...
public class PublicExpenseController extends ApiController {
    /**
     * 服务对象
     */
    @Resource
    ...
    public R selectAll(Page<PublicExpense> page, PublicExpense publicExpense) {
        return success(this.publicExpenseService.page(page, new QueryWrapper<>(publicExpense)));
    }
    ...
    public R selectOne(@PathVariable Serializable id) {
        return success(this.publicExpenseService.getById(id));
    }
    ...
    public R insert(@RequestBody PublicExpense publicExpense) {
        return success(this.publicExpenseService.save(publicExpense));
    }
    ...
    public R update(@RequestBody PublicExpense publicExpense) {
        return success(this.publicExpenseService.updateById(publicExpense));
    }
    ...
    public R delete(@RequestParam("idList") List<Long> idList) {
        return success(this.publicExpenseService.removeByIds(idList));
    }
}
