...
@ApiOperation(value = "药品入库订单查询接口",notes = "根据查询所有药品入库订单",httpMethod = "GET",response = String.class)
public R findAll(){
...
public R delete(Integer id){
      return   this.uh03StoreInCService.removeById(id)?R.ok().message("删除成功"):R.ok().message("删除失败");
}
}
